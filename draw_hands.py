...
landmarks_style = mp_drawing.DrawingSpec(color=(0, 0, 255), thickness=10)  # Red landmarks
connections_style = mp_drawing.DrawingSpec(color=(200, 200, 200), thickness=10)  # Gray borders
...
# Example usage:
directory_path = '/Users/sphemister/Documents/Github/tt-hackathon-2024/tenstorrent_images'
all_file_paths = get_all_file_abspaths(directory_path)
draw_hand_landmarks_and_connections(all_file_paths, '/Users/sphemister/Documents/Github/tt-hackathon-2024/image_queue')